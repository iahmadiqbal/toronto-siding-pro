    ...
    <section className="relative min-h-[600px] flex items-center">
      ...
      <div className="relative container mx-auto py-20">
        <div className="max-w-2xl">
          <span className="inline-block bg-secondary text-secondary-foreground text-sm font-semibold px-4 py-1.5 rounded-full mb-6 animate-fade-in-up">
          ...
          <div className="flex flex-wrap gap-4 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
            <Button asChild size="lg" className="bg-secondary text-secondary-foreground hover:bg-amber-dark text-base px-8">
              <Link to="/contact">
                Get Free Estimate
