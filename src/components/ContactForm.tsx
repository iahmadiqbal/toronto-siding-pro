        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-muted-foreground mb-8 max-w-md">
              Ready to transform your property? Contact us for a free, no-obligation estimate. We serve Toronto and the entire GTA.
            </p>
            <div className="space-y-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+16471234567" className="font-semibold text-foreground">(647) 123-4567</a>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-lg gradient-navy flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <a href="mailto:info@torontosiding.ca" className="font-semibold text-foreground">info@torontosiding.ca</a>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-11 h-11 rounded-lg gradient-navy flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p className="font-semibold text-foreground">123 Yonge St, Toronto, ON</p>
                </div>
              </div>
            </div>
          </div>
          <form onSubmit={handleSubmit} className="bg-card rounded-2xl shadow-card p-8 border border-border space-y-4">
            ...
            <Textarea
              ...
              maxLength={1000}
            />
            <Button type="submit" size="lg" className="w-full bg-secondary text-secondary-foreground hover:bg-amber-dark text-base">
