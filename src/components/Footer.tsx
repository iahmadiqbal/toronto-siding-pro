        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8 mb-10 xl:mb-12">
          <div className="pl-2">
            <Link to="/" className="flex items-center gap-1 mb-4">
              ...
              <span className="text-xl xl:text-2xl font-semibold text-primary-foreground tracking-tight whitespace-nowrap">Toronto Siding</span>
            </Link>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="tel:+16471234567" className="flex items-center gap-2 text-primary-foreground/70 text-sm hover:text-secondary transition-colors font-medium">
                <FaPhone className="h-3.5 w-3.5 shrink-0" /> (647) 123-4567
              </a>
              <a href="mailto:info@torontosiding.ca" className="flex items-center gap-2 text-primary-foreground/70 text-sm hover:text-secondary transition-colors font-medium break-all">
                <FaEnvelope className="h-3.5 w-3.5 shrink-0" /> info@torontosiding.ca
              </a>
              <p className="flex items-start gap-2 text-primary-foreground/70 text-sm font-light">
